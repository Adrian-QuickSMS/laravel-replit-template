            ...
            <div class="card mb-1">
                <div class="card-body p-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <h6 class="mb-0" style="font-size: 13px;"><i class="fas fa-users text-primary me-1"></i>3. Recipients</h6>
                    ...
                    <ul class="nav nav-pills nav-pills-sm mb-1" style="font-size: 11px;">
                        ...
                        <li class="nav-item"><button class="nav-link py-0 px-2" data-bs-toggle="pill" data-bs-target="#contactBook">Contacts</button></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="contactBook">
                            <div class="row">
                                <div class="col-6">
                                    <div class="border rounded p-1" style="max-height: 50px; overflow-y: auto; font-size: 10px;">
                                        @foreach($lists as $list)
                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="{{ $list['id'] }}" id="list{{ $list['id'] }}"><label class="form-check-label" for="list{{ $list['id'] }}">{{ $list['name'] }} ({{ $list['count'] }})</label></div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="border rounded p-1" style="max-height: 50px; overflow-y: auto; font-size: 10px;">
                                        @foreach($tags as $tag)
                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="{{ $tag['id'] }}" id="tag{{ $tag['id'] }}"><label class="form-check-label" for="tag{{ $tag['id'] }}"><span style="color: {{ $tag['color'] }};">●</span> {{ $tag['name'] }}</label></div>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
