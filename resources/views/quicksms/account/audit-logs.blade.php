...
$(document).ready(function() {
    ...
    var EXTENDED_ACTION_TYPES = {
        ...
        suspended: { category: 'messaging', severity: 'high', label: 'Template Suspended' },
        created: { category: 'messaging', severity: 'low', label: 'Template Created' },
        edited: { category: 'messaging', severity: 'low', label: 'Template Edited' },
        'status-changed': { category: 'messaging', severity: 'medium', label: 'Template Status Changed' },
