...
function renderDownloads() {
    ...
    paginated.forEach(function(item) {
        ...
        if (item.status === 'Completed') {
            html += '<button class="action-dropdown-item" onclick="downloadFile(' + item.id + ')"><i class="fas fa-download me-2"></i>Download</button>';
        }
        html += '<button class="action-dropdown-item" onclick="viewDetails(' + item.id + ')"><i class="fas fa-info-circle me-2"></i>Details</button>';
        html += '<button class="action-dropdown-item text-danger" onclick="deleteFile(' + item.id + ')"><i class="fas fa-trash me-2"></i>Delete</button>';
        html += '</div>';
        html += '</div>';
        html += '</td>';
        html += '</tr>';
...
function viewDetails(id) {
    closeAllActionMenus();
    console.log('TODO: View details for download ID:', id);
    console.log('TODO: Open details modal or drawer');
}
