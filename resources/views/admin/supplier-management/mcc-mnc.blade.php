...
@section('title', 'MCC/MNC/Prefixes - Routing')
...
<div class="page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">MCC/MNC/Prefixes</li>
    </ol>
</div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            <select class="form-select" id="filterPrefix" onchange="applyMccFilters()">
                <option value="">All MCC Codes</option>
                @php
                    $mccCodes = App\Models\MccMnc::select('mcc')
                        ->whereNotNull('mcc')
                        ->distinct()
                        ->orderBy('mcc')
                        ->pluck('mcc');
...
function submitAddMccMnc() {
    ...
    var networkType = form.querySelector('[name="network_type"]').value;
