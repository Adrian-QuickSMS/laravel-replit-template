...
<div class="admin-page">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Supplier Reporting</li>
        </ol>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-start mb-3">
        <div>
            ...
            <p class="text-muted mb-0 small">Supplier finance data across all routes</p>
        </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div style="max-width: 400px;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" id="searchInput" placeholder="Search supplier, invoice ref...">
                    </div>
                </div>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            ...
                                            <div class="dropdown multiselect-dropdown" data-filter="suppliers" id="supplierDropdown">
                                                ...
                                                <div class="dropdown-menu w-100 p-2" style="max-height: 320px; overflow-y: auto;">
                                                    <div class="mb-2">
                                                        <input type="text" class="form-control form-control-sm supplier-search-input" placeholder="Search suppliers..." id="supplierSearchInput">
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-2 border-bottom pb-2">
                                                        <a href="#" class="small text-decoration-none select-all-btn">Select All</a>
                                                        <a href="#" class="small text-decoration-none clear-all-btn">Clear</a>
                                                    </div>
                                                    <div id="supplierCheckboxList">
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-001" id="supSUP001"><label class="form-check-label small" for="supSUP001">UK SMS Direct</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-002" id="supSUP002"><label class="form-check-label small" for="supSUP002">International Routes</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-003" id="supSUP003"><label class="form-check-label small" for="supSUP003">Premium Gateway</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-004" id="supSUP004"><label class="form-check-label small" for="supSUP004">Bulk SMS Provider</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-005" id="supSUP005"><label class="form-check-label small" for="supSUP005">Enterprise Connect</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-006" id="supSUP006"><label class="form-check-label small" for="supSUP006">Mobile Networks UK</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-007" id="supSUP007"><label class="form-check-label small" for="supSUP007">SMS Hub Europe</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-008" id="supSUP008"><label class="form-check-label small" for="supSUP008">Direct Route Ltd</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-009" id="supSUP009"><label class="form-check-label small" for="supSUP009">Value Routes</label></div>
                                                        <div class="form-check"><input class="form-check-input" type="checkbox" value="SUP-010" id="supSUP010"><label class="form-check-label small" for="supSUP010">Express Delivery</label></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="table-responsive" id="tableContainer">
                            <table class="table display" id="financeDataTable" style="min-width: 900px">
                                ...
                                <tbody id="billingTableBody">
                                    <tr class="drill-row" data-status="finalised" data-value="December 2025" data-supplier="SUP-001">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="December 2025" data-supplier="SUP-002">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="December 2025" data-supplier="SUP-003">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="November 2025" data-supplier="SUP-001">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="November 2025" data-supplier="SUP-002">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="November 2025" data-supplier="SUP-003">
                                    ...
                                    <tr class="drill-row" data-status="adjusted" data-value="October 2025" data-supplier="SUP-001">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="October 2025" data-supplier="SUP-002">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="October 2025" data-supplier="SUP-003">
                                    ...
                                    <tr class="drill-row" data-status="provisional" data-value="September 2025" data-supplier="SUP-004">
                                    ...
                                    <tr class="drill-row" data-status="provisional" data-value="September 2025" data-supplier="SUP-005">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="August 2025" data-supplier="SUP-001">
                                    ...
                                    <tr class="drill-row" data-status="finalised" data-value="August 2025" data-supplier="SUP-002">
...
// Admin-only: Mock suppliers data for global view
var allSuppliers = [
    { id: 'SUP-001', name: 'UK SMS Direct' },
    { id: 'SUP-002', name: 'International Routes' },
    { id: 'SUP-003', name: 'Premium Gateway' },
    { id: 'SUP-004', name: 'Bulk SMS Provider' },
    { id: 'SUP-005', name: 'Enterprise Connect' },
    { id: 'SUP-006', name: 'Mobile Networks UK' },
    { id: 'SUP-007', name: 'SMS Hub Europe' },
    { id: 'SUP-008', name: 'Direct Route Ltd' }
];

// Admin-only: Initialize Supplier filter with multi-select dropdown and search
function initSupplierFilter() {
    ...
    var checkboxList = document.getElementById('supplierCheckboxList');
    
    if (!supplierDropdown || !searchInput) return;
...
function updateSupplierDropdownLabel() {
    ...
    var checked = supplierDropdown.querySelectorAll('.form-check-input:checked');
    var labelSpan = supplierDropdown.querySelector('.dropdown-label');
    
    if (checked.length === 0) {
        labelSpan.textContent = 'All Suppliers';
...
// Admin-only: Handle supplier name clicks to navigate to Supplier Details
function initSupplierLinks() {
    document.addEventListener('click', function(e) {
        var supplierLink = e.target.closest('.supplier-link');
        if (supplierLink) {
            e.preventDefault();
            var supplierId = supplierLink.dataset.supplierId;
            // Navigate to Admin Supplier Details page (stub route if not built)
            var supplierDetailsUrl = '/admin/suppliers/' + supplierId;
            console.log('[Supplier Reporting] Navigating to supplier details:', supplierDetailsUrl);
            window.location.href = supplierDetailsUrl;
        }
    });
}
...
var BillingService = {
    ...
    getData: function(filters) {
        ...
        if (filters.subSuppliers && filters.subSuppliers.length) {
            filters.subSuppliers.forEach(function(s) { params.append('subSupplier[]', s); });
        }
...
function initSubSupplierUserFiltering() {
    var subSupplierDropdown = document.getElementById('subSupplierDropdown');
    var userDropdown = document.getElementById('userDropdown');
    
    if (!subSupplierDropdown || !userDropdown) return;
    
    var subSupplierCheckboxes = subSupplierDropdown.querySelectorAll('.form-check-input');
    var userItems = userDropdown.querySelectorAll('.form-check[data-subsupplier]');
    
    subSupplierCheckboxes.forEach(function(cb) {
        cb.addEventListener('change', function() {
            var selectedSubSuppliers = Array.from(subSupplierCheckboxes)
                .filter(function(c) { return c.checked; })
                .map(function(c) { return c.value; });
            
            userItems.forEach(function(item) {
                var userSubSupplier = item.getAttribute('data-subsupplier');
                if (selectedSubSuppliers.length === 0 || selectedSubSuppliers.indexOf(userSubSupplier) !== -1) {
                    item.style.display = 'block';
                } else {
                    item.style.display = 'none';
...
function applyFilters() {
    ...
    // Admin-only: Supplier filter (multi-select)
    var supplierDropdown = document.getElementById('supplierDropdown');
    if (supplierDropdown) {
        var checkedSuppliers = Array.from(supplierDropdown.querySelectorAll('.form-check-input:checked'));
        var totalSuppliers = supplierDropdown.querySelectorAll('.form-check-input').length;
        if (checkedSuppliers.length > 0 && checkedSuppliers.length < totalSuppliers) {
            checkedSuppliers.forEach(function(cb) {
                var label = cb.closest('.form-check').querySelector('label').textContent;
                activeFilters.push({ type: 'Supplier', value: label, id: cb.value });
            });
        }
    }
    ...
    var filterParams = {
        supplier: selectedSupplierId ? selectedSupplierId.value : '',
        billingMonths: getSelectedValues('billingMonths'),
        subSuppliers: getSelectedValues('subSuppliers'),
    ...
    console.log('[Supplier Reporting] Applying filters:', filterParams);
    
    // Admin-only: Filter table rows by supplier
    filterTableBySupplier(filterParams.supplier);
...
function renderBillingTable(data) {
    ...
    data.forEach(function(row) {
        ...
        html += '<tr class="' + attrs.classes + '"' + attrs.attrs + ' data-month="' + row.billingMonth + '" data-value="' + row.billingMonthLabel + '" data-status="' + row.billingStatus.toLowerCase() + '" data-supplier="' + supplierId + '">' +
            '<td>' +
...
function resetFilters() {
    ...
    // Admin-only: Clear Supplier filter (multi-select)
    var supplierDropdown = document.getElementById('supplierDropdown');
    if (supplierDropdown) {
        supplierDropdown.querySelectorAll('.form-check-input').forEach(function(cb) {
            cb.checked = false;
        });
        updateSupplierDropdownLabel();
    }
    ...
    document.querySelectorAll('.multiselect-dropdown').forEach(function(dropdown) {
        ...
        dropdown.querySelectorAll('.form-check[data-subsupplier]').forEach(function(item) {
            item.style.display = 'block';
        });
        updateDropdownLabel(dropdown);
    });
    ...
    // Admin-only: Show all rows (clear supplier filter)
    filterTableBySupplier('');
...
// Admin-only: Filter table rows by supplier
function filterTableBySupplier(supplierId) {
    var rows = document.querySelectorAll('#billingTableBody tr.drill-row');
    rows.forEach(function(row) {
        if (!supplierId || row.dataset.supplier === supplierId) {
            row.style.display = '';
        } else {
...
var mockDrillData = {
    supplier: [
        { label: 'UK SMS Direct', billable: 45678, nonBillable: 890, total: 46568, cost: '£1,455.25', status: 'Finalised' },
        { label: 'International Routes', billable: 38500, nonBillable: 650, total: 39150, cost: '£1,230.72', status: 'Finalised' },
        { label: 'Premium Gateway', billable: 32456, nonBillable: 567, total: 33023, cost: '£1,038.59', status: 'Finalised' },
        { label: 'Bulk SMS Provider', billable: 28934, nonBillable: 489, total: 29423, cost: '£925.89', status: 'Finalised' },
        { label: 'Enterprise Connect', billable: 18765, nonBillable: 312, total: 19077, cost: '£610.48', status: 'Finalised' }
    ],
    day: [
