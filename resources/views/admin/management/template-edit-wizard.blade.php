...
var mockTemplates = {
    'TPL-22334': { templateId: 'TPL-22334', name: 'Safety Alert', accountId: 'ACC-0123', accountName: 'BuildRight Construction', channel: 'sms', trigger: 'portal', content: 'SAFETY NOTICE: {AlertType} alert for site {SiteName}. Please follow evacuation procedures.', status: 'live' },
    'TPL-11223': { templateId: 'TPL-11223', name: 'Delivery Update', accountId: 'ACC-1234', accountName: 'Acme Corporation', channel: 'sms', trigger: 'api', content: 'Your order {OrderID} is now {Status}. Track at: {TrackingURL}', status: 'live' },
    'TPL-90123': { templateId: 'TPL-90123', name: 'Account Statement', accountId: 'ACC-2345', accountName: 'FinServe Solutions', channel: 'sms', trigger: 'api', content: 'Your {Month} statement is ready. Balance: {Balance}. View details at {PortalURL}', status: 'live' },
    'TPL-78901': { templateId: 'TPL-78901', name: 'Flash Sale Alert', accountId: 'ACC-3456', accountName: 'HealthCare Plus', channel: 'basic_rcs', trigger: 'portal', content: 'Flash Sale! 50% off all wellness products. Use code: {PromoCode}. Ends midnight!', status: 'draft' },
    'TPL-34567': { templateId: 'TPL-34567', name: 'Product Launch', accountId: 'ACC-5678', accountName: 'TechStart Ltd', channel: 'rich_rcs', trigger: 'portal', content: '', status: 'draft' },
    'TPL-12345': { templateId: 'TPL-12345', name: 'Welcome Message', accountId: 'ACC-1234', accountName: 'Acme Corporation', channel: 'sms', trigger: 'portal', content: 'Hi {FirstName}, welcome to Acme! Your account is ready.', status: 'live' },
    'TPL-23456': { templateId: 'TPL-23456', name: 'Appointment Reminder', accountId: 'ACC-1234', accountName: 'Acme Corporation', channel: 'basic_rcs', trigger: 'api', content: 'Reminder: Your appointment is on {Date} at {Time}. Reply YES to confirm.', status: 'live' },
    'TPL-56789': { templateId: 'TPL-56789', name: 'Order Confirmation', accountId: 'ACC-9012', accountName: 'EduLearn Academy', channel: 'sms', trigger: 'email-to-sms', content: 'Order #{OrderID} confirmed. Total: {Amount}. Delivery by {Date}.', status: 'live' },
    'TPL-89012': { templateId: 'TPL-89012', name: 'Customer Feedback', accountId: 'ACC-7890', accountName: 'RetailMax Group', channel: 'rich_rcs', trigger: 'email-to-sms', content: '', status: 'live' }
};
