<div class="dlabnav admin-sidebar">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="{{ request()->routeIs('admin.system.routing') || request()->routeIs('admin.security.country-controls') || request()->routeIs('admin.mcc-mnc.*') ? 'mm-active' : '' }}">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
            ...
            <li class="{{ request()->routeIs('admin.system.*') && !request()->routeIs('admin.system.routing') ? 'mm-active' : '' }}">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
