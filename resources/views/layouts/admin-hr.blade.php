...
<head>
    ...
    <meta name="description" content="QuickSMS HR Management" />
    <meta name="format-detection" content="telephone=no">
    <link rel="shortcut icon" type="image/png" href="{{asset('images/favicon.png') }}?v={{ time() }}">
    
    <title>QuickSMS HR | @yield('title', $page_title ?? '')</title> 
...
<body class="admin-control-plane admin-console">
    ...
    <div id="main-wrapper" class="show">
        <div class="nav-header admin-nav-header">
            <a href="{{ url('/admin') }}" class="brand-logo">
                ...
                <span class="brand-title">
                    <img src="{{ asset('images/quicksms-logo-white.png') }}" alt="QuickSMS HR" style="height: 35px; width: auto;">
                </span>
            </a>
        ...
        @include('elements.admin-hr-sidebar')
