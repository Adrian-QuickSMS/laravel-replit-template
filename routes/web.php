...
Route::controller(QuickSMSController::class)->group(function () {
    ...
    Route::get('/management/templates/create/step-1', 'templateCreateStep1')->name('management.templates.create.step1');
    Route::get('/management/templates/create/step-2', 'templateCreateStep2')->name('management.templates.create.step2');
    Route::get('/management/templates/create/step-3', 'templateCreateStep3')->name('management.templates.create.step3');
