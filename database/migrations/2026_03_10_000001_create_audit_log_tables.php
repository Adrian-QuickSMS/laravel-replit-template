...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::unprepared("
            ...
            ALTER TABLE account_audit_log FORCE ROW LEVEL SECURITY;
        ...
        DB::unprepared("
            ...
            ALTER TABLE number_audit_log FORCE ROW LEVEL SECURITY;
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                IF EXISTS (
                    ...
                    ALTER TABLE contact_timeline_events
                        ALTER COLUMN source_module DROP DEFAULT;
                    ALTER TABLE contact_timeline_events
                        ALTER COLUMN source_module TYPE VARCHAR(50) USING source_module::VARCHAR(50);
                    DROP TYPE IF EXISTS timeline_source_module CASCADE;
                END IF;
                ...
                IF EXISTS (
                    ...
                    DROP TYPE IF EXISTS timeline_actor_type CASCADE;
                END IF;
            END \$\$;
        ");
    }
