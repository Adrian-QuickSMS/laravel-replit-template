...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE rcs_agent_status_histories ADD CONSTRAINT rcs_agent_status_histories_from_status_check CHECK (from_status::text = ANY (ARRAY['draft','submitted','in_review','approved','rejected']::text[]))");
        DB::statement("ALTER TABLE rcs_agent_status_histories ADD CONSTRAINT rcs_agent_status_histories_to_status_check CHECK (to_status::text = ANY (ARRAY['draft','submitted','in_review','approved','rejected']::text[]))");
    }
};
