...
/**
 * RCS Agent Comment - internal and customer-visible comments on agent requests
 *
 * Follows the SenderIdComment pattern exactly.
 */
class RcsAgentComment extends Model
{
    public $timestamps = false;

    protected $table = 'rcs_agent_comments';
