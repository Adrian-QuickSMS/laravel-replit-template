...
class Account extends Model
{
    ...
    const STATUS_TRANSITIONS = [
        ...
        self::STATUS_ACTIVE_STANDARD => [self::STATUS_ACTIVE_DYNAMIC, self::STATUS_TEST_STANDARD, self::STATUS_TEST_DYNAMIC, self::STATUS_SUSPENDED, self::STATUS_CLOSED],
        self::STATUS_ACTIVE_DYNAMIC => [self::STATUS_ACTIVE_STANDARD, self::STATUS_TEST_STANDARD, self::STATUS_TEST_DYNAMIC, self::STATUS_SUSPENDED, self::STATUS_CLOSED],
