...
const NumbersAdminService = (function() {
    ...
    const mockDatabase = {
        numbers: [
            ...
            { id: 'NUM-010', number: '+447700904444', country: 'UK', type: 'vmn', status: 'cancelled', mode: 'portal', account: 'Old Client Ltd', accountId: 'ACC-007', subAccount: 'Legacy', subAccountId: 'SUB-010', capabilities: [], cost: 2.00, supplier: 'Sinch', route: 'UK-Direct-Standard', network: 'O2', portedTo: null, apiWebhookUrl: null, optoutConfig: null, created: '2024-01-15', modified: '2025-06-01' },
